...
help)
  ...
  echo "    -csv_delimiter?=',': the csv delimiter character"
  echo "    -csv_enclosure?='\"': the csv enclosure character"
  echo "    -csv_escape?='\"': the csv_escape character"
  ...
  echo "    -truncate?=false': truncate the existing table records before import"
